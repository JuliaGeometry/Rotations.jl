...
@inline (::Type{SPQ})(t::NTuple{9}) where {SPQ <: SPQuat} = convert(SPQ, UnitQuaternion(t))
@inline Base.getindex(spq::SPQuat, i::Int) = convert(UnitQuaternion, spq)[i]
@inline Base.Tuple(spq::SPQuat) = Tuple(convert(UnitQuaternion, spq))

@inline function (::Type{Q})(spq::SPQuat) where Q <: UnitQuaternion
    # Equation (45) in
...
@inline function (::Type{SPQ})(q::UnitQuaternion) where SPQ <: SPQuat
...
@inline Base.:*(spq::SPQuat, x::StaticVector) = UnitQuaternion(spq) * x

@inline Base.:*(spq::SPQuat, r::Rotation) = UnitQuaternion(spq) * r
@inline Base.:*(spq::SPQuat, r::RotMatrix) = UnitQuaternion(spq) * r
@inline Base.:*(r::Rotation, spq::SPQuat) = r * UnitQuaternion(spq)
@inline Base.:*(r::RotMatrix, spq::SPQuat) = r * UnitQuaternion(spq)
@inline Base.:*(spq1::SPQuat, spq2::SPQuat) = UnitQuaternion(spq1) * UnitQuaternion(spq2)
